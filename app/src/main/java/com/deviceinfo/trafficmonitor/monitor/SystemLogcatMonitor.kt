...
class SystemLogcatMonitor(
    ...
    companion object {
        ...
        private val RULES = listOf(
            ...
            Rule(Regex("(?i)TelephonyRegistry|getImei|getDeviceId|IccProvider|RILJ|Subscription"), AccessCategory.TELEPHONY, "Telephony / SIM", "READ_PHONE_STATE", "tel.imei", "TELEPHONY"),
